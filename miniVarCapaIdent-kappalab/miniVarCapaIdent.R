# usage:
# R --slave --vanilla --args "[inDirectory]" "[outDirectory]" < miniVarCapaIdent.R
# example: 
#  R --slave --vanilla --args "${PWD}/miniVarCapaIdentInFiles" "${PWD}/miniVarCapaIdentOutFiles" < miniVarCapaIdent.R
